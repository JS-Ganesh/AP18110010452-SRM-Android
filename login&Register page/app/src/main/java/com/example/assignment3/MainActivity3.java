...
public class MainActivity3 extends AppCompatActivity {
    ...
    public void register(View view) {
        ...
        if (user.isEmpty() || pass.isEmpty() || phone.isEmpty() || mail.isEmpty()) {
            Toast.makeText(MainActivity3.this, "SOME THING IS EMPTY", Toast.LENGTH_SHORT).show();
        } else {
            Intent i = new Intent(MainActivity3.this, MainActivity.class);
            Toast.makeText(MainActivity3.this, "Signup Successful", Toast.LENGTH_SHORT).show();
            startActivity(i);
        }
    }
}